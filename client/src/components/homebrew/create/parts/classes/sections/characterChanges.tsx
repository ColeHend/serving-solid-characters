				...
				<Button disabled={disableAddCharacterChange()}
					onClick={() => {
						...
						if (differentChangeTypes.includes(selectedChangeType())) {
							if (selectedChangeType() === CharacterChangeTypes.Spell) {
								
							} else if (selectedChangeType() === CharacterChangeTypes.SpellSlot) {
								
							} else if (selectedChangeType() === CharacterChangeTypes.UseNumber) {
