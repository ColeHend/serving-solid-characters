...
import { Button, MenuButton, Select } from "../../shared/components";
...
const NavMenu: Component<Props> = (props) => {
    const [{ userStyle, defaultShowList, setDefaultShowList, defaultIsMobile: isMobile, setDefaultIsMobile, defaultUserSettings, setDefaultUserSettings }, other] = splitProps(props, ["userStyle", "defaultShowList", "setDefaultShowList", "defaultIsMobile", "setDefaultIsMobile", "defaultUserSettings", "setDefaultUserSettings"]);
