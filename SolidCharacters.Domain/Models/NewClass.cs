...
namespace SolidCharacters.Domain.SRDSpells
{
    using System;
    ...
    public partial class The5ESrdClassesJson
    {
        public static List<The5ESrdClassesJson> FromJson(string json) => JsonConvert.DeserializeObject<List<The5ESrdClassesJson>>(json, SolidCharacters.Domain.SRDSpells.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<The5ESrdClassesJson> self) => JsonConvert.SerializeObject(self, SolidCharacters.Domain.SRDSpells.Converter.Settings);
    }
