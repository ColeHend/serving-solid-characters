...
const TRIGGERS: [RegExp, string][] = [
    ...
    [/\byou (know|learn) (the |two |one |a )?.{0,40}(spell|cantrip)s?\b/i, "spell grant"],
    [/\b(cantrips?|spells?) of your choice\b/i, "spell choice"],
    [/\bas an? (bonus action|reaction|magic action)\b|\byou can take the .{0,30}\baction\b/i, "action grant"],
