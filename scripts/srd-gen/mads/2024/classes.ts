...
const expertiseChoice = (options: string, count: string): CommandSpecInput =>
    add("Expertise", { proficiency: "choice", options, count });
...
const languageChoice = (count: string): CommandSpecInput =>
    add("Languages", { name: "choice", options: STANDARD_LANGUAGES, count });
...
export const map: MadMap = {
    ...
    // "You gain Expertise in two of your skill proficiencies of your choice." (levels 2 and 9 —
    // each level instance keys its own picks on the sheet)
    "Bard/Expertise": [expertiseChoice(ALL_SKILLS, "2")],
    // skip: Jack of All Trades, Font of Inspiration (recharge change),
    ...
    // Role choice — branch groups: Protector's proficiencies vs Thaumaturge's extra cantrip
    // (Thaumaturge's Wis-modifier check bonus isn't representable and stays narrative).
    "Cleric/Divine Order": [
        { type: "Add", category: "WeaponProficiencies", value: { weapon: "Martial Weapons" }, group: 1, groupLabel: "Protector" },
        { type: "Add", category: "ArmorProficiencies", value: { armor: "Heavy Armor" }, group: 1, groupLabel: "Protector" },
        { type: "Add", category: "Spells", value: { ID: "choice", options: "Guidance,Light,Mending,Resistance,Sacred Flame,Spare the Dying,Thaumaturgy", count: "1", spellLevel: "0" }, group: 2, groupLabel: "Thaumaturge" },
    ],
    ...
    // Role choice — branch groups mirroring Divine Order (Magician's check bonus stays narrative).
    "Druid/Primal Order": [
        { type: "Add", category: "Spells", value: { ID: "choice", options: "Druidcraft,Elementalism,Guidance,Mending,Message,Poison Spray,Produce Flame,Resistance,Shillelagh,Spare the Dying,Starry Wisp", count: "1", spellLevel: "0" }, group: 1, groupLabel: "Magician" },
        { type: "Add", category: "WeaponProficiencies", value: { weapon: "Martial Weapons" }, group: 2, groupLabel: "Warden" },
        { type: "Add", category: "ArmorProficiencies", value: { armor: "Medium Armor" }, group: 2, groupLabel: "Warden" },
    ],
    ...
    // "Choose one of your skill proficiencies with which you lack Expertise. You gain Expertise in
    // that skill. ... You know two languages of your choice."
    "Ranger/Deft Explorer": [expertiseChoice(ALL_SKILLS, "1"), languageChoice("2")],
    // "Choose two of your skill proficiencies with which you lack Expertise. You gain Expertise in those skills."
    "Ranger/Expertise": [expertiseChoice(ALL_SKILLS, "2")],
    // skip: Weapon Mastery, Fighting Style (choice),
    //       Tireless (temp HP), Relentless Hunter, Precise Hunter (situational
    ...
    // "You gain Expertise in two of your skill proficiencies of your choice." (levels 1 and 6)
    "Rogue/Expertise": [expertiseChoice(ALL_SKILLS, "2")],
    // skip: Sneak Attack (rider), Weapon Mastery, Steady Aim
    ...
    "Wizard/Scholar": [expertiseChoice("Arcana,History,Investigation,Medicine,Nature,Religion", "1")],
    // skip: Ritual Adept, Memorize Spell, Spell Mastery / Signature Spells
 ...
 * (Former entries in this block — Bard/Rogue/Ranger Expertise, Deft Explorer, Wizard Scholar,
 * Cleric Divine Order, Druid Primal Order — are all encoded in the map above via the Expertise
 * choice form and branch groups.)
 */
