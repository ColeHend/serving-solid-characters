...
public class SrdInfoRepository : ISrdInfoRepository
{
  ...
  public List<Item> GetItems(string version = "2014")
  {
    ...
    SolidCharacters.Domain.DTO.Updated.Item[] json = Array.Empty<SolidCharacters.Domain.DTO.Updated.Item>();
    try
    {
      json = jsonService.GetJson<SolidCharacters.Domain.DTO.Updated.Item[]>(pathKey) 
    ...
    if (versionInt == 2014)
    {
      var weapons = jsonService.GetJson<SolidCharacters.Domain.DTO.Updated.Item[]>($"srd/{version}/weapons") 
        ?? Array.Empty<SolidCharacters.Domain.DTO.Updated.Item>();
      var armor = jsonService.GetJson<SolidCharacters.Domain.DTO.Updated.Item[]>($"srd/{version}/armor") 
        ?? Array.Empty<SolidCharacters.Domain.DTO.Updated.Item>();
