...
using SolidCharacters.CustomActionFilters;
using SolidCharacters.Repository.Data;
using SolidCharacters.models;
using SolidCharacters.Domain.Entities;
using SolidCharacters.Repository;
using SolidCharacters.Helpers;
using SolidCharacters.Repository.Extensions.Repositories;

namespace SolidCharacters.Controllers
{
    [ApiController]
    [Route("api/[controller]/[action]")]
    public class UsersController : Controller
    {
        private readonly SolidCharactersContext dbContext;
        private readonly IUserMapper UserMapper;
        private readonly ITokenRepository TokenRepo;
        private readonly IUserRepository userRepository;


        public UsersController(SolidCharactersContext dbContext, IUserMapper UserMapper, ITokenRepository tokenRepo, IUserRepository userRepository)
        {
