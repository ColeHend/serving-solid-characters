...
var APP_VERSION = self.APP_VERSION || import.meta.env?.VITE_APP_VERSION || "dev";
var BUILD_TIME = self.BUILD_TIME || import.meta.env?.VITE_BUILD_TIME || (/* @__PURE__ */ new Date()).toISOString();
...
var manifestEntries = self.__WB_MANIFEST;
