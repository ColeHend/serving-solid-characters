...
import { buildReviewRows, type FeatStepProps } from './wizard.shared';
 ...
 * feat also lives here, next to the other terminal actions.
 */
export const StepReview: Component<FeatStepProps> = (props) => {
    ...
    <div class={styles.stack}>
      ...
      <Show when={props.isExisting()}>
        <div class={`${wizStyles.banner} ${wizStyles.bannerWarn}`}>
          <span>This feat is already in your homebrew collection. Deleting removes it permanently.</span>
          <Button theme="error" onClick={() => void props.deleteFeat()}>Delete feat</Button>
        </div>
      </Show>
    </div>
  );
