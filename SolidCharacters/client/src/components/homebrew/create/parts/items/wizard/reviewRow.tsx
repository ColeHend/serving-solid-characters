...
import type { ItemReviewRow } from './wizard.shared';
import styles from '../../classes/wizard/stepReview.module.scss';

// Thin sibling of the class/subclass wizards' ReviewRow — identical body, typed to the
// items review-row shape (its step field is the items enum).
