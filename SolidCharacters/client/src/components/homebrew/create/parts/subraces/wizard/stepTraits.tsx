...
/**
 * Traits step — a flat trait list (subraces have no levels, so no level pills).
    ...
    <div class={styles.step}>
      <div class={wiz.card}>
        <div class={styles.cardHead}>
          <span class={wiz.cardLabel}>Subrace traits</span>
      ...
      <Show when={!traits().length}>
        <div class={wiz.banner}>
          <span>Traits are what set a lineage apart from its parent race — extra senses, resistances, innate spells.</span>
        </div>
      </Show>
    </div>
  );
