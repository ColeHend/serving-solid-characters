...
/**
 * Languages step — the languages every member knows, plus an optional player
 * choice (how many extra languages, and from which options).
 */
export const StepLanguages: Component<StepProps> = (props) => {
  ...
  // in it (prefilled SRD/homebrew data, custom entries), so unknown values still
  // show as chips.
