...
import { buildReviewRows, featLabel, type StepProps } from './wizard.shared';
...
export const StepReview: Component<StepProps> = (props) => {
  const rows = createMemo(() => buildReviewRows(
    props.formGroup,
    props.extras,
    featLabel(props.originFeats(), (props.formGroup.get('feat') as string) || ''),
  ));
