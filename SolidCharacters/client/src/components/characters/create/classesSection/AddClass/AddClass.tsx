    ...
    return <Modal show={props.show} title="Add a class">
        <div class={`${styles.AddClassTable}`}>
            <Table data={props.allClasses} columns={isMobile ?["name","primaryAbility"] :["name","primaryAbility","hitdie"]}>
                ...
                <Row rowNumber={2} onClick={(e,class5e: Class5E)=>handleClick(class5e)} style={isDarkTheme() ? {"border-bottom": "1px solid rgba(255, 255, 255, 0.65)"} : {"border-bottom":"1px solid rgba(0,0,0,0.65)"}} />
            </Table>
        </div>
    </Modal>
}