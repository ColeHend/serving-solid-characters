...
export const aboutPage:Component = () => {
  ...
  return <Body class={`${styles.body}`}>
    ...
    <p>
      <a href="https://commons.wikimedia.org/wiki/File:Parchment.00.jpg" target="_blank" class={`${styles.underlineText}`}>Where we Found it.</a>
    </p>
    <h2>Solbera's dnd fonts</h2>
    <p>
      <a href="https://github.com/jonathonf/solbera-dnd-fonts" target="_blank" class={`${styles.underlineText}`}>Thanks to Solbera for the awesome fonts.</a>
    </p>
    <h2>Linkedin's Logo</h2>
    <p>
      <a href="https://brand.linkedin.com/in-logo" target="_blank" class={`${styles.underlineText}`}>Fair use page</a>
    </p>
    <h2>Backgrounds</h2>
    <p>
      Please note that the background images used in this project are generated by the AI, chatGPT because neither of us have the artistic skills to create them ourselves.
       We have made every effort to ensure that these AI-generated images do not infringe upon any existing copyrights. 
    </p>
